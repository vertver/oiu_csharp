...
namespace oiu_wpf_csharp
{
    ...
    internal class Analyzer
    {
        ...
        private void Init()
        {
            ...
            result = Bass.BASS_Init(-1, 44100, BASSInit.BASS_DEVICE_DEFAULT, IntPtr.Zero);
        ...
        public static void Play(string filename, int vol)
        {
         /*   Stop();
            if (Init(44100))
            {   // Кнопка "play", напрямую взаимодействует с уровнем громкости. (А, ну теперь ясно почему этот говнокод не работает)
